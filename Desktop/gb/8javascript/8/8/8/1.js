...
*/
  ...
  const clEl = event.target.classList.contains("super_element")
    ? "присутствует"
    : "отсутствует";
  console.log(`Класс "super_element" ${clEl} в элементе 
...
// После того как добавила return в задание 3, текст из 3 задания стал выводиться первым. Не выходили из функции addEventListener
